...
//                    after[c.row][c.column] != 0);
    ...
    public void testValue() {
		...
		if (result2 == 2 || result2 == 4 || result2 == 8 || result2 == 16){
			test1 = 1;
		}
    ...
    public void winningValueMustBePositive() {
    	
        gameLogic.resizeBoard(4, 4, 0);
        
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void winningValueMustBeDivisableByTwo() {
